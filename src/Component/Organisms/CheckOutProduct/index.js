...
>>>>>>> 662e95f1d731aefb6f3af4bb610d3e5daa94f421
      ...
      <div key={flower.id} className="checkout-img">
        ...
        <div className="count">
          ...
          <div className="plus">
            <button
              onClick={() =>
                UpdateQuality(flower.id, flower.qty > 1 ? flower.qty - 1 : 1)
              }
              className="sub-add"
            >
            ...
            <button
              onClick={() => UpdateQuality(flower.id, flower.qty + 1)}
              className="sub-add"
            >
...
>>>>>>> 662e95f1d731aefb6f3af4bb610d3e5daa94f421
        ...
        <div className="delete">
          ...
          <button
            onClick={() => handleRemoveProduct(flower.id)}
  ...
  return (
    <div className="checkout-checkout">
      <div className="checkout-heading">
        ...
        <button onClick={handleHiddenIcon} className="btn-delete">
          Edit
        </button>
      </div>

      <div className="checkout-over">{renderFlower()}</div>
